...
#             bot.send_document(ADMIN_CHAT_ID, f, caption="📊 Логи бота за день")
...
#             return
#         message = "📊 Топ популярных конвертаций за день:\n\n"
...
#     scheduler.every().day.at("23:55").do(send_conversion_stats, bot=bot)
